...
function login_handle(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const response = yield (0, auth_1.login)(email, password);
            if (response != null) {
                const session = jsonwebtoken_1.default.sign({ email, id: response }, process.env.JWT_SECRET, {
                    algorithm: "HS256",
                    expiresIn: "7d",
                });
                res
                ...
                const LoginSession = jsonwebtoken_1.default.sign({ email, id: response }, process.env.JWT_SECRET, {
                    algorithm: "HS256",
                    expiresIn: 60 * 5,
                });
                res
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!(0, validator_1.isEmail)(email))
                ...
                if (result) {
                    const session = jsonwebtoken_1.default.sign({ email, id }, process.env.JWT_SECRET, {
                        algorithm: "HS256",
                        expiresIn: "7d",
                    });
                    res
...
function delete_profile(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!data)
                throw new Error("Session is Invalid");
            res.clearCookie("Authorization").status(200).json("Account Deleted Successfully");
        }
        catch (error) {
            res.status(400).json(`Bad Request: ${error === null || error === void 0 ? void 0 : error.message}`);
        }
...
function verify_login(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!/^\d{6}$/.test(code))
                throw new Error("Verification code is invalid");
            const id = yield (0, auth_1.verify)(email, code);
            const session = jsonwebtoken_1.default.sign({ email, id }, process.env.JWT_SECRET, {
                algorithm: "HS256",
                expiresIn: "7d",
            });
